...
export const els = {
  ...
  sizeEstimateField: document.getElementById('size-estimate-field'),
  avifOption: document.getElementById('avif-option'),
  qualityLabel: document.getElementById('quality-label'),
  exportResolution: document.getElementById('export-resolution'),
  customDimsField: document.getElementById('custom-dims-field'),
  exportWidth: document.getElementById('export-width'),
  exportHeight: document.getElementById('export-height'),
  exportLinkDims: document.getElementById('export-link-dims'),
  exportDimsInfo: document.getElementById('export-dims-info'),
  exportDimsLabel: document.getElementById('export-dims-label'),
  exportWarningField: document.getElementById('export-warning-field'),
